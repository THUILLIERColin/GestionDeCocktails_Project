<?php
 ...
 function fav(){  
           //on récupere le numéro de la recette qu'on vient d'aimer
            ...
            if(file_exists("Donnees/donneeFav.php")&&filesize("Donnees/donneeFav.php")){  
        ...
        file_put_contents("Donnees/donneeFav.php",'<?php $utilisateur = '.var_export($utilisateur, true).';'.'?>');                                                                                                
        }
